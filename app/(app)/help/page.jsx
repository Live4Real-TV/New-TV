...
export const metadata = {
  title: "帮助中心 - NewTV",
  description: "NewTV 帮助中心，了解如何使用 NewTV 的各项功能",
};
  ...
  return (
    <div className="w-full max-w-4xl mx-auto page-enter">
      ...
      <div className="text-center mt-8 mb-10">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mx-auto">了解 NewTV 的核心功能与使用方法</p>
      </div>
      ...
      <div className="space-y-12">
        ...
        <Section id="video-source" number="2" title="如何添加视频源">
          <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 space-y-6">
            <p className="text-gray-600 leading-relaxed">视频源是 NewTV 搜索和播放视频的数据来源。你可以添加兼容 CMS 接口的资源站来扩展可搜索的内容范围。</p>
        ...
        <Section id="danmaku-source" number="3" title="如何添加弹幕源">
          <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 space-y-6">
            <p className="text-gray-600 leading-relaxed">弹幕源提供视频播放时的实时弹幕数据。目前 NewTV 支持配置一个弹幕源。本项目调取弹幕采用客户端直接流式获取，未经过服务器代理。</p>
            <div className="space-y-4">
              <h3 className="font-bold text-gray-900">操作步骤</h3>
              <ol className="list-decimal list-inside space-y-3 text-gray-600">
                <li>
        ...
        <Section id="import-export" number="4" title="如何导入与导出">
          <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 space-y-6">
            <p className="text-gray-600 leading-relaxed">NewTV 支持将所有配置（包括视频源、弹幕源、豆瓣代理设置等）导出为 JSON 文件，方便备份和迁移到其他设备。</p>
